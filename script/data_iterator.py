...
class DataIterator:
  def __init__(self, source,
    ...
    #print('self.n_uid: %d self.n_mid: %d self.n_cat: %d'%(self.n_uid, self.n_mid, self.n_cat)) 
    #self.n_uid: 543060 self.n_mid: 367983 self.n_cat: 1601

    f_meta = open("item-info", "r") # id to category  0001057170  Books
    meta_map = {}
    for line in f_meta:
    ...
    f_review = open("reviews-info", "r") # A12W8NRSYR593I     000100039X    5.0    1359158400
